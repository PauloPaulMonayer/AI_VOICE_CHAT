  ...
  return (
    <footer className="footer-container">
      <div className="footer-content">
        {/* חלק שמאלי: טקסט זכויות יוצרים */}
        <div className="footer-left">
          <span className="footer-text">
            © {currentYear} All rights reserved by Paulo Monayer
          </span>
        </div>

        {/* חלק ימני: אייקונים חברתיים */}
        <ul className="footer-socials">
          <li>
            <a
              href="mailto:monayer42@gmail.com"
          ...
          <li>
            <a
              href="https://www.linkedin.com/in/paulo-monayer/"
              className="social-link"
              target="_blank"
              rel="noopener noreferrer"
            >
          ...
          <li>
            <a
              href="https://github.com/PauloPaulMonayer"
              className="social-link"
              target="_blank"
              rel="noopener noreferrer"
            >
